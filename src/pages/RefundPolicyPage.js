    ...
    <div className="refundpolicypage">
      ...
      <section className="wishdeck-we-us-or-our-parent">
        ...
        <div className="eligibility-for-refunds-parent">
          ...
          <div className="the-product-or-service-you-pur-parent">
        ...
        <FrameComponent1 />
        <div className="non-refundable-items-list">
        ...
        <div className="non-refundable-items-list1">
        ...
        <div className="non-refundable-items-list2">
