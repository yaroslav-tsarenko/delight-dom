...
const CancellationPolicyPage = () => {
  return (
    <div className="cancellationpolicypage">
      ...
      <section className="cancellation-process">
        <CancellationPeriod />
        ...
        <div className="cancellation-steps">
          <h1 className="cancellation-process1">
            <ol className="cancellation-process2">
        ...
        <div className="cancellation-steps1">
        ...
        <div className="cancellation-steps2">
        ...
        <div className="cancellation-steps3">
        ...
        <div className="cancellation-steps4">
        ...
        <div className="cancellation-steps5">
